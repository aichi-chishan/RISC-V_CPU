...
//   修改数值     → 修改 `define 后面的值
//
// 当前阶段 (Phase 1) : 单周期 RV32I (为五级流水预留架构)
//==============================================================================
...
//==============================================================================
`define RVC_CFG_IMEM_SIZE_KB  64    // 指令存储器大小 (KB)
`define RVC_CFG_DMEM_SIZE_KB  64    // 数据存储器大小 (KB)
...
// --- Phase 2: 五级流水线 ---
// `define RVC_CFG_PIPELINE_5STAGE   // 插入 IF/ID, ID/EX, EX/MEM, MEM/WB 流水寄存器
